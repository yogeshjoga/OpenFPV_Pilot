...
// ── Data ──────────────────────────────────────────────────────
const AUDIENCES = [
  { icon: '🎓', label: 'B.Tech / B.E / B.Sc Students' },
  { icon: '✈️', label: 'Aviation Students' },
  { icon: '🔬', label: 'Researchers' },
  { icon: '🕹️', label: 'Hobbyists' },
  { icon: '🏛️', label: 'Universities & Colleges' },
]
...
const LEVELS = [
  {
    ...
    includes: [
      { icon: '🕹️', text: 'Shared controller — team-wise rotation' },
      { icon: '🖥️', text: 'Full simulation practice sessions' },
      { icon: '📚', text: 'Theory: Drone fundamentals & regulations' },
      { icon: '⚛️', text: 'Physics of flight & UAV mechanics' },
      { icon: '🌬️', text: 'Aerodynamics principles' },
      { icon: '📜', text: 'Level 3 Simulation Skill Certificate' },
    ],
  },
  {
    id: 'level2',
    ...
    includes: [
      { icon: '🕹️', text: 'Personal controller for each student' },
      { icon: '🖥️', text: '1-week simulation training' },
      { icon: '🚁', text: 'Cinewoop indoor + outdoor practice' },
      { icon: '📚', text: 'Theory: Drone systems & components' },
      { icon: '⚛️', text: 'Physics & flight dynamics' },
      { icon: '🌬️', text: 'Aerodynamics principles' },
      { icon: '📜', text: 'Level 2 Moderate Skill Certificate' },
    ],
  },
  {
    id: 'level1',
    ...
    includes: [
      ...
      { icon: '🖥️', text: '1-week simulation training' },
      { icon: '🚁', text: 'Cinewoop indoor + outdoor practice' },
      { icon: '📚', text: 'Theory, physics & aerodynamics' },
      { icon: '🔧', text: 'In-depth drone component knowledge' },
      { icon: '🤖', text: 'AI / ML model integration' },
      { icon: '🛠️', text: 'FPV drone build from scratch' },
      { icon: '⚙️', text: 'Component selection & battery packing' },
      { icon: '🔩', text: 'Assembly & troubleshooting' },
      { icon: '💻', text: 'ESC / FC programming' },
      { icon: '🔥', text: 'Soldering skills' },
      { icon: '🏆', text: 'Professional Certificate — DGCA eligible' },
    ],
  },
]
