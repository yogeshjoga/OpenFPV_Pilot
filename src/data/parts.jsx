...
export const PART_CATEGORIES = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <Ruler size={20} />, tip: 'Match motor size to frame: 5" frame → 2206–2308 stator' },
          { icon: <Battery size={20} />, tip: 'Match KV to battery: 4S → 2300–2500 KV, 6S → 1700–1900 KV' },
          { icon: <Scale size={20} />, tip: 'Freestyle: prioritize torque (lower KV, taller stator). Racing: prioritize speed (higher KV).' },
          { icon: <Flag size={20} />, tip: 'Check motor weight — target 28–35g per motor for 5" freestyle' },
          { icon: <Lightbulb size={20} />, tip: 'Trusted brands: T-Motor, Brotherhobby, Xing, Emax, iFlight Xing-E' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <Target size={20} />, tip: 'Beginners: Start with a 5" Stretched-X or a Tiny Whoop — large community and parts availability.' },
          { icon: <Film size={20} />, tip: 'Want clean footage? Go Deadcat or Cinewhoop geometry.' },
          { icon: <Star size={20} />, tip: 'Racing: choose True-X with stiff 3mm carbon arms. Lower drag profile.' },
          { icon: <Wrench size={20} />, tip: 'Check arm thickness — freestyle 5" should have 4–5mm arms. Thinner snaps on hard crashes.' },
          { icon: <Star size={20} />, tip: 'Pick a frame with spare parts availability. Popular = easier to fix.' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <AlertTriangle size={20} />, tip: 'NEVER charge LiPo unattended — use a fireproof LiPo bag or metal ammo box.' },
          { icon: <TrendingDown size={20} />, tip: 'Never discharge below 3.3V per cell — damages cells and causes swelling.' },
          { icon: <Plug size={20} />, tip: 'Always store at 3.8V/cell (storage charge). Never store fully charged or empty.' },
          { icon: <Thermometer size={20} />, tip: 'After flying, let battery cool 10–15 minutes before recharging.' },
          { icon: <Trash2 size={20} />, tip: 'Dispose of swollen or puffed packs immediately — take to electronics recycling, never trash.' },
          { icon: <CheckCircle2 size={20} />, tip: 'Trust: CNHL, GNB, Tattu, Roaring Top, RDQ are reputable LiPo brands.' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <BarChart2 size={20} />, tip: 'A 5" freestyle motor can pull 40–60A peak. Choose ESC rated 45A+.' },
          { icon: <Hash size={20} />, tip: 'Rule of thumb: ESC current = motor stall current × 1.3 safety margin.' },
          { icon: <Flag size={20} />, tip: 'Racing: 35–45A per motor ESC is usually enough on 4S.' },
          { icon: <Film size={20} />, tip: '6S builds: choose 50–60A ESC minimum per motor.' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <Plug size={20} />, tip: '5+ UARTs — you need them for: receiver, VTX, GPS, ESC telemetry, HD camera.' },
          { icon: <RefreshCw size={20} />, tip: 'Bidirectional DSHOT support — enables RPM filtering (biggest tune improvement possible).' },
          { icon: <Radio size={20} />, tip: 'Built-in Bluetooth or WiFi for wireless Betaflight configuration.' },
          { icon: <Zap size={20} />, tip: 'Onboard voltage regulator (BEC) for 3.3V and 5V to power peripherals.' },
          { icon: <Lightbulb size={20} />, tip: 'Trusted FC brands: Holybro, Matek, Foxeer, IFlight, BetaFPV.' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <Ruler size={20} />, tip: 'Frame size dictates max prop: 5" frame → 5" prop (5140, 5148, 5149 most common)' },
          { icon: <Settings size={20} />, tip: 'Match pitch to KV: high KV motors → lower pitch. Low KV motors → higher pitch.' },
          { icon: <Flag size={20} />, tip: 'Racing: 5145 or 5148 tri or quad blade for aggressive punch.' },
          { icon: <Film size={20} />, tip: 'Cinematic: 5142 or HQ 5x4x3V2S for smooth quiet footage.' },
          { icon: <Lightbulb size={20} />, tip: 'Trusted brands: HQ Props (most popular), DAL, Gemfan, T-Motor.' },
          { icon: <AlertTriangle size={20} />, tip: 'Always install props in correct rotation — forward-spinning front-left/rear-right, reverse on the other diagonal.' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <DollarSign size={20} />, tip: 'Beginners: Start with analog (Runcam, Foxeer camera + cheap VTX). Total cost ~$30–50.' },
          { icon: <Film size={20} />, tip: 'Want great footage? DJI O3 is the gold standard — budget ~$200 for the system.' },
          { icon: <Flag size={20} />, tip: 'Racing: Analog or HDZero for lowest latency response.' },
          { icon: <Radio size={20} />, tip: 'Long range: DJI O3 for best penetration and range at reasonable cost.' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'tips',
        items: [
          { icon: <Award size={20} />, tip: 'Best overall: ExpressLRS — open protocol, huge community, excellent performance, $15–25 receivers.' },
          { icon: <Radio size={20} />, tip: 'Long range specialist: TBS Crossfire. For flying 5km+ or penetrating thick obstacles.' },
          { icon: <Gamepad2 size={20} />, tip: 'Beginner radios: RadioMaster Boxer (ELRS), RadioMaster TX16S, Jumper T-Pro.' },
          { icon: <Link size={20} />, tip: 'Always match protocol: your radio TX module must match your drone receiver protocol.' },
        ],
      },
    ],
  },
